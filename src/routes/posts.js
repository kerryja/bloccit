...
router.post("/topics/:topicId/topics/create", validation.validatePosts, topicController.create);
...
router.post("/topics/:topicId/topics/:id/update", validation.validatePosts, topicController.update);
